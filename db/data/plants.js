export default [
  {
    ...
    beginnerFriendly: true, // yes(skilled) no(unskilled)
    safeForPetsOrChildren: true, // yes no
  },
  {
    ...
    plantHeight: 'large', // small (<50cm), medium(50-100cm), large(>100cm)
    beginnerFriendly: true, // yes(skilled) no(unskilled)
    safeForPetsOrChildren: false, // yes no
  },
  {
  ...
  },
  {
    ...
    sunlightRequired: 'medium', // <1hr, 1-2hr, >2hr
    plantHeight: 'large', // small (<50cm), medium(50-100cm), large(>100cm)
    beginnerFriendly: false, // yes(skilled) no(unskilled)
    safeForPetsOrChildren: false, // yes no
  },
  {
  ...
  },
  {
    ...
    tempDescription: 'Pachira aquatica is content in average household conditions: between 16-24°C. Avoid exposing your Pachira to temperatures below 10°C.',
    humidityDescription: 'The Money Tree likes increased humidity levels. Mist regularly or relocate to a typically steamy room such as the bathroom or kitchen.',
    heightDescription: 'This plant is fast-growing and usually rises to an ultimate height of 3 metres. Regular pruning and pinching will keep the plant from growing too big.',
    toxicityDescription: 'This plant is considered non-toxic. Safe around children and pets.',
    // for filters
    category: 'bonsai', // succulent, palm, bonsai, fern, foliage
    idealLocation: ['office', 'living room', 'bedroom', 'bathroom', 'kitchen'], // 'office', 'living room', 'bedroom', 'bathroom', 'balcony', 'kitchen'
    sunlightRequired: 'medium', // <1hr, 1-2hr, >2hr
    plantHeight: 'large', // small (<50cm), medium(50-100cm), large(>100cm)
    beginnerFriendly: 'false', // true false
    safeForPetsOrChildren: 'true', // true false
  },
  {
    ...
    tempDescription: 'Monstera like warm conditions from 18-27°C. Lower temperatures will reduce the plant\'s growth rate. It will tolerate 12°C and above but avoid cold draughts.',
    humidityDescription: 'This plant will do best in average to high humidity levels. Cannot cope in dry air situations so mist occasionally for best results.',
    heightDescription: 'Adansonii is a slow to moderate-grower depending on conditions. Use a moss pole to support the plant or cut back if it gets too big.',
    toxicityDescription: 'The leaves of the Monkey Mask are poisonous so be sure to keep away from pets and children. Do not consume.',
    // for filters
    category: 'foliage', // succulent, palm, bonsai, fern, foliage
    idealLocation: ['office', 'living room', 'bathroom', 'kitchen'], // 'office', 'living room', 'bedroom', 'bathroom', 'balcony', 'kitchen'
    sunlightRequired: 'medium', // <1hr, 1-2hr, >2hr
    plantHeight: 'medium', // small (<50cm), medium(50-100cm), large(>100cm)
    beginnerFriendly: 'true', // true false
    safeForPetsOrChildren: 'false', // true false
  },
  {
    ...
    tempDescription: 'Asplenium nidus Campio benefits from cool to average household temperatures between 16°C and 21°C. Avoid draughts.',
    humidityDescription: 'The Champion\'s Bird\'s Nest does not like hot, dry conditions. Try to maintain at least some degree of humidity by misting regularly or relocating to steamier rooms. This plant is ideal for the bathroom or kitchen.',
    heightDescription: 'This Bird\'s Nest Fern is slow growing and has an ultimate indoor height of around 60cm, spreading to around 45cm. It can grow larger, but only in very humid conditions.',
    toxicityDescription: 'Not toxic to humans or pets',
    // for filters
    category: 'fern', // succulent, palm, bonsai, fern, foliage
    idealLocation: ['bathroom', 'kitchen'], // 'office', 'living room', 'bedroom', 'bathroom', 'balcony', 'kitchen'
    sunlightRequired: 'medium', // <1hr, 1-2hr, >2hr
    plantHeight: 'medium', // small (<50cm), medium(50-100cm), large(>100cm)
    beginnerFriendly: 'true', // true false
    safeForPetsOrChildren: 'true', // true false
  },
  {
    ...
    tempDescription: 'Cycas revoluta does well in average household temperatures (16-24°C), but should not be allowed to go lower than 13°C. Avoid cold draughts.',
    humidityDescription: 'Sago Palms prefer increased humidity levels. Mist regularly or leave in a steamy bathroom for an hour to give it a boost. If it rains in the summer, take it outside to soak up some extra moisture.',
    heightDescription: 'The Sago Palm is a slow growing plant with a maximum indoor height of around 60cm to 80cm.',
    toxicityDescription: 'The leaves of the revoluta are toxic if eaten. Keep out of reach of children and animals.',
    // for filters
    category: 'palm', // succulent, palm, bonsai, fern, foliage
    idealLocation: ['office', 'living room', 'bedroom'], // 'office', 'living room', 'bedroom', 'bathroom', 'balcony', 'kitchen'
    sunlightRequired: 'medium', // <1hr, 1-2hr, >2hr
    plantHeight: 'medium', // small (<50cm), medium(50-100cm), large(>100cm)
    beginnerFriendly: 'false', // true false
    safeForPetsOrChildren: 'false', // true false
